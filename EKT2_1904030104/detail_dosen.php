...
<body>
  ...
  <div class="row">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!-- konten -->
      <h3><i class="fas fa-users"> Detail data dosen</i></h3>
      <hr>

      <ul class="list-group">
        <li class="list-group-item active"><?= $dosen['nama']; ?></li>
        <li class="list-group-item">NIDN : <?= $dosen['NIDN']; ?></li>
        <li class="list-group-item">alamat : <?= $dosen['alamat']; ?></li>
        <li class="list-group-item">jenis kelamin : <?= $dosen['jenis_kelamin']; ?></li>
        <li class="list-group-item">agama : <?= $dosen['agama']; ?></li>
        <li class="list-group-item">Pendidikan S1 : <?= $dosen['s1']; ?></li>
        <li class="list-group-item">Pendidikan S2 : <?= $dosen['s2']; ?></li>
        <li class="list-group-item">Pendidikan S3 : <?= $dosen['s3']; ?></li>
