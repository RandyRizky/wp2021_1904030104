...
$id = $_GET['id'];
$dosen = query("SELECT * FROM data_dosen WHERE id=$id");
    ...
    <div class="row">
        <div class="col-md-2 pr-3 pt-4 bg-secondary">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="tambah.php"><i class="fas fa-user-edit"></i> Input dafdos</a>
                    <hr>
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><img src="imagee/foto11.png" width="250px"></li>
                <li class="list-group-item"><?= "<b>" . $dosen['nama'];
                                            "</b>" ?></li>
                ...
                <li class="list-group-item">Pendidikan terakhir : <?= $dosen['pendidikan']; ?></li>
                <li class="list-group-item">
                    <a href="hapus.php?id=<?= $dosen['id']; ?>" onclick="confirm('apakah anda akan menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a> |
