    ...
    <div class="row">
        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><img src="imagee/foto11.png<?= $camaba['foto_maba']; ?>" width="250px"></li>
                <li class="list-group-item">
                    <a href="edit.php?id=<?= $camaba['id']; ?>" class="btn btn-warning" role="button">Edit</a> |
                    <a href="hapus.php?id=<?= $camaba['id']; ?>" onclick="confirm('apakah anda akan menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a> |
